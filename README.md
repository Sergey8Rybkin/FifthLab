...
С помощью ЯндексSDK можно совершать настройки графики в игре.

![image](https://user-images.githubusercontent.com/100475554/206007484-23d45819-eb43-4c0f-b58e-2335161bc4c4.png)

Можно подключить показ полноэкранной рекламы, и выставить награду игрока за её просмотр. Сюда же можно включить рекламные банеры.

![image](https://user-images.githubusercontent.com/100475554/206007995-292ae73e-4957-4c83-85ca-cd228e93d9df.png)

Ещё одним из применений YandexSDK может стать настройка и подключение внутриигровых покупок

![image](https://user-images.githubusercontent.com/100475554/206009439-ce89fb15-cf16-4d55-af22-673993660593.png)

Как более мелкие настройки, которые больше про "QualityOfLife" чем опыт игрока, это добавление ярлыка игры на рабочий стол пользователя, и выключение звука игры, так называемый расфокус, если игрок свернул игру.

Ну и последним уже приятным для разработчиков может стать возможность дать игроку оценить игру, и оставить отзыв.
